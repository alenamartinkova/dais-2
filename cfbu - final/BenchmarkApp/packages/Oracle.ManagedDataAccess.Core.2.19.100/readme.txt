Oracle.ManagedDataAccess.Core NuGet Package 2.19.100 README
===========================================================
...
============
1) .NET 5 Support
ODP.NET Core 2.19.100 supports .NET 5.
...
Bug Fixes since Oracle.ManagedDataAccess.Core NuGet Package 2.19.91
===================================================================
31873207 ORA-12614 ENCOUNTERED WHILE USING SINGLE-SESSION PROXY AUTHENTICATION
26123054 "UNEXPECTED PACKET RECEIVED" ERROR IS ENCOUNTERED WHEN NULL RETURNED FROM A SELECT QUERY
29669425 GETDECIMAL() THROWS SYSTEM.INVALIDCASTEXCEPTION: 'SPECIFIED CAST IS NOT VALID.'
31626886 KEEPALIVE ON LINUX AND MACOS VIA NEW CORE INTERFACE
32067106 BULKCOPY IS NOT WORKING WITH ODPM/C
32033930 TWO-SESSION PROXY CONNECTION USING SEPS FAILS WITH ORA-01017
31917192 DESERIALIZATION OF XML FILE WITH ORACLE PROVIDER TYPES THROWS EXCEPTION
